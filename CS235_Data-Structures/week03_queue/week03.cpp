...
*    11 May 2017 -  modified test2 so it call the back() function
*                   because it wasn't being tested.
************************************************************************/
...
{
   cerr << "Made a copy of the queue." << endl;
   out << "{ ";
   while (!q.empty())
   {
      out << q.front() << ' ';
   ...
   out << '}';
   cerr << "Deleting the extraction copy Queue." << endl;
   return out;
}
#endif // TEST2
...
void testPushPopTop()
{
   ...
   try
   {
      ...
      cout << "\tq2 = " << q2 << endl;
      cout << "\tq3 = " << q3 << endl;
      cerr << "Deleting q1 and q2 and q3" << endl;
   }
   catch (const char * sError)
   {
      cout << sError << endl;
